...
def main():
    """Train the RQ2 10-way size-conditioned model at a fixed patch size."""
    ...
    stem = "rq2_size_conditioned_aligner" if args.seed == 0 else f"rq2_size_conditioned_seed{args.seed}_aligner"
