...
def main():
    """Train the baseline architecture against naturalistic rather than templated text."""
    ...
    stem = "rq5_naturalistic_aligner" if args.seed == 0 else f"rq5_naturalistic_seed{args.seed}_aligner"
