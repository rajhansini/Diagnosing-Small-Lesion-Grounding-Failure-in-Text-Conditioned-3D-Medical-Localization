...
This directory contains data, not source code, so there are no line counts to report here; the per-file line counts for the scripts that write these tables are in [`../src/README.md`](../src/README.md).
